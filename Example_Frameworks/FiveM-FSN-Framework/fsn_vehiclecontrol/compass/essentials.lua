...
function drawText(str, x, y, style)
        ...
        if style.colour ~= nil then
                SetTextColour(style.colour.r or 255, style.colour.g or 255, style.colour.b or 255, style.colour.a or 255)
        else
                SetTextColour(255, 255, 255, 255)
        end

        if style.shadow ~= nil then
                SetTextDropShadow(style.shadow.distance or 0, style.shadow.r or 0, style.shadow.g or 0, style.shadow.b or 0, style.shadow.a or 255)
        else
                SetTextDropShadow(0, 0, 0, 0, 255)
        end

        if style.border ~= nil then
                SetTextEdge(style.border.size or 1, style.border.r or 0, style.border.g or 0, style.border.b or 0, style.border.a or 255)
        end
